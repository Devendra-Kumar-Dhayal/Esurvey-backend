...
const createDropdownOptionValidation = [
  body('type')
    .isIn(['project', 'way_bridge', 'loading_point', 'unloading_point', 'transporter', 'wb_loading_point'])
    .withMessage('Type must be project, way_bridge, loading_point, unloading_point, transporter, or wb_loading_point'),
  body('name').trim().notEmpty().withMessage('Name is required'),
